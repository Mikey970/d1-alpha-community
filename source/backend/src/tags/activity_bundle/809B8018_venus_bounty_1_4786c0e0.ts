...
/** venus_bounty_1 80800533 (809B8018). Bundle 4786C0E0. */
export const tag: ActivityBundleTag = {
  activityName: "venus_bounty_1",
  activityNames: ["venus_bounty_1", "venus_chapter_2", "venus_portal_1"],
  bundle: 0x4786c0e0,
  class: 0x80800533,
  tag: 0x809b8018,
  rows: [
    {
      typeId: ActivityBundleItemType.Scoreboard,
      typeIndex: 0,
      nameHash: 0x021f3833,
    }, // scoreboard
    {
      typeId: ActivityBundleItemType.HardWipeGlobals,
      typeIndex: 1,
      nameHash: 0x1d420449,
    }, // hard_wipe_globals
    {
      typeId: ActivityBundleItemType.Timer,
      typeIndex: 2,
      nameHash: 0xc562283a,
    }, // lifetime_timer
    {
