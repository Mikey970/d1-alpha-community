...
everything is included except the base game download. no extra emulator, server or runtime installs.

1. download the package from [Releases](https://github.com/Mikey970/d1-alpha-community/releases) and extract it somewhere you can keep it.
2. run Setup.cmd and select the original **Destiny (Dec 3, 2013 prototype).rar**. an untouched extracted copy works too.
3. let setup finish, open the launcher, choose your character and weapons, then hit Play.
